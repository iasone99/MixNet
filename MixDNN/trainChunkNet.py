...
from MixDNN import mixCNN, chunkNet
...
def main():
    ...
    for epoch in range(hp.epochs):
        ...
        for i, data in enumerate(data_loader):
            ...
            mel, mel_target = batch_mels(data=data, mel_spectrogram=mel_spectrogram, num_frames=num_frames,
                                         tts=tts)
            ...
            plt.savefig("loss_gradientsChunk.svg")
